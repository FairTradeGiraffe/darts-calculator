...
function AcoNotificationServiceClass() {
    ...
    this.notifications = [];
    this.usedIds = [];
    this.validTypes = ['info','error','warning','azurblue','confirmation'];
}
...
AcoNotificationServiceClass.prototype.pushNotification = function(type, title, message){
    ...
    */
    ...
    }else if(notification.type === 'azurblue'){
        notificationContent += '<img src="./include/img/icons/info_circle_notification/info-circle-white.svg" width="24px" height="24px" id="Layer_1"></img>';
    }else{
