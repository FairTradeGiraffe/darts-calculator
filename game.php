  ...
  <div class="col-12 col-md-1 col-lg-1 col-xl-1 darts" style="margin-left:-0.5rem;">
    ...
    <div class="col-12 col-md-12 col-lg-6 col-xl-5">
      ...
      <ul class="list-group list-group-horizontal list-inline">
        ...
        <li class="list-group-item flex-fill"><button id="undomove" type="button" class="btn btn-primary" style="margin-top:5px; margin-right:15px; float:left;"><i class="fa-solid fa-clock-rotate-left fa-lg"></i> UNDO</button><button id="showstats" type="button" class="btn btn-primary" style="margin-top:5px; margin-right:15px; float:center;"><i class="fa-solid fa-chart-line fa-lg"></i> Statistiken</button><button id="showinfos" type="button" class="btn btn-primary" style="margin-top:5px; margin-right:15px; float:center;"><i class="fa-solid fa-circle-info fa-lg"></i> Infos</button><button id="quitgame" type="button" class="btn btn-primary" style="margin-top:5px; float:right;"><i class="fa-solid fa-right-from-bracket fa-lg"></i> Beenden</button></li>
      </ul>
